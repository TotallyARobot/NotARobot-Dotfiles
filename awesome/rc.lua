...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag(names, s, {machi.mylayout,l.tile,l.tile,l.tile,l.tile,l.tile})
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, width = 800 , height = 25, shape = rounded_rect_shape})
...
awful.spawn.with_shell("picom --legacy-backends")

awful.spawn(terminal.." tty-clock -ctx")
sleep(1)
awful.spawn(terminal.." neofetch --gap 20")
sleep(1)
awful.spawn(terminal.." cbonsai -lim 'Hello World'")
sleep(1)
awful.spawn(terminal.." pipes.sh")
sleep(.5);
